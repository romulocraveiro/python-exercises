...
if idade >= 96:
    print("Atendimento exclusivamente em casa. Para fazer o agendamento, ligue para 3333 32333 ou clique aqui.\n")
else: 
    if idade >=75:
        ...
        if uppercase == "C":
            ...
            if uppercase == "S":
                ...
                print("\nOpção inválida. Atualize a página e informe os dados novamente.\n")
